      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          <ActionCard
            ...
            description="Upload legal documents for AI-powered analysis and comprehensive risk assessment"
            features={["OCR Processing", "AI Analysis", "Interactive Summary"]}
          ...
          <ActionCard
            ...
            description="Browse and book consultations with qualified legal professionals in your area"
            features={[
              "Browse Profiles",
              "Check Availability",
              "Book Consultation",
            ...
            onClick={onFindLawyerClick} // 👈 trigger scroll
          />
        </div>
      </div>
    </section>
